 ...
 * Supports: select (dropdown), boolean (checkbox), number (input), text (input)
 */
export function SchemaField({ name, field, value, onChange }: SchemaFieldProps) {
  // Select → Dropdown
  ...
  if (field.type === "number") {
    const numValue = value !== undefined ? Number(value) : (field.default as number) ?? 0;
